...
line2 = print("--------------------------")
line3 = print(f"Total Months: {str(total_months)}")
line4 = print(f"Total: ${str(total_net)}")
line5 = print(f"Average Change: ${str(round(average_change,2))}")
line6 = print(f"Greatest Increase in Profits: {greatest_date} (${str(greatest_inc)})")
line7 = print(f"Greatest Decrease in Profits: {worst_date} (${str(greatest_dec)})")
